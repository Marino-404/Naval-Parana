...
export const cardStyles =
  "xl:w-1/5 w-full md:h-40 bg-gradient-to-br from-detail to-[#b6c8d9] p-5 rounded-lg border-2 border-primary px-5 transition-all duration-300 border-solid border-secondary shadow-lg hover:shadow-xl ";
...
export const textFooterStyle =
  "text-xs xl:text-sm flex flex-row gap-2 items-center";

export const iconsFooterStyle = "text-secondary";
